...
function parseArch(): string {
  ...
  if (!value || !["a", "a-top10", "b", "c", "d", "d-chrono", "e", "e-top10", "f", "h", "skill", "null"].includes(value)) {
    console.error(`Invalid --arch value: ${value}. Use a, a-top10, b, c, d, d-chrono, e, e-top10, f, h, skill, or null.`);
    process.exit(1);
  }
  return value;
}
