...
const ARCH_LABELS: Record<string, string> = {
  ...
  e: "hybrid",
  "e-top10": "hybrid-top10",
  coached: "coached-loop-target",
  f: "aegis",
  h: "dspy",
...
async function loadGenerator(arch: string): Promise<GenerateFn> {
  switch (arch) {
    ...
    case "e-top10":
      return (await import("./generators/arch-e-top10.ts")).generate;
    case "coached":
      return (await import("./generators/arch-coached.ts")).generate;
    case "f":
...
function parseArch(): string {
  ...
  if (!value || !["a", "a-top10", "b", "c", "d", "d-chrono", "e", "e-top10", "f", "h", "skill", "coached", "null"].includes(value)) {
    console.error(`Invalid --arch value: ${value}. Use a, a-top10, b, c, d, d-chrono, e, e-top10, f, h, skill, coached, or null.`);
    process.exit(1);
  }
  return value;
}
