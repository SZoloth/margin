    ...
    it("snapshot captures state before switch", async () => {
      ...
      const snapshotFn = () => {
        ...
        return {
          ...
          filePath: null,
          isDirty: false,
          highlights: [{ id: "h1", document_id: "doc1", color: "yellow", text_content: "test", from_pos: 0, to_pos: 4, prefix_context: null, suffix_context: null, created_at: 1000, updated_at: 1000, exported_at: null }],
          marginNotes: [],
